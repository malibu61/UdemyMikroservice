...
namespace MultiShop.Presentation.WebApi.Controllers
{
    ...
    public class OrderDetailsController : ControllerBase
    {
        ...
        public OrderDetailsController(GetOrderDetailQueryHandler getOrderDetailQueryHandler, GetByIdOrderDetailQueryHandler getOrderDetailByIdQueryHandler, CreateOrderDetailCommandHandler createOrderDetailCommandHandler, RemoveOrderDetailCommandHandler removeOrderDetailCommandHandler, UpdateOrderDetailCommandHandler updateOrderDetailCommandHandler)
        {
        ...
        {
            var value = await _getOrderDetailByIdQueryHandler.Handle(new GetByIdOrderDetailQuery(id));
            return Ok(value);
        }
